...
!  			
  REAL (8), PARAMETER :: NU = 0.25D0, NU2 = NU * NU,NH=0.01D0
  REAL (8), PARAMETER :: G0 = -5.0D0, G01 = 0.03D0, GAM_EFF0 = -0.01D0
   ...
   !GSTP  = G0/INTERACTION
    ...
    DO L = 1, INTERACTION
      ...
      DO I = 1, NX
          ...
          V(I) = (INTERACTION - L) * (1.0D0/INTERACTION) * (X2(I) * NU2 / 2.0D0+CI*X(I)*NH)  
